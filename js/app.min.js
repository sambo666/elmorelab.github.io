...
/* harmony import */ var _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
...
window.addEventListener("load", function () {
  var STREAMERS_PATH = 'https://sambo666.github.io/elmorelab.github.io/streamers/streamers.json?v=123';
  //const STREAMERS_PATH = '../streamers/streamers.json?v=123';

  var clinetId = "eqeootvs7wxgswfm46vud0cu7tcreo";
  var clinetSecret = "0jiyngk8dxxok0olzilcu5pgepfqc4";

  //let youtubekey = 'AIzaSyBTJzjOBu60nHncD0QDcO-TsBXja8967rI';

  var numCallbackRuns = 0;
  var links = [];
  var streamBlock = document.getElementById('-js-streams-list');
  if (!streamBlock) return;
  var category = streamBlock.dataset.stream;
  function getTwitchAuthorization() {
    var url = "https://id.twitch.tv/oauth2/token?client_id=".concat(clinetId, "&darkpopout&client_secret=").concat(clinetSecret, "&grant_type=client_credentials");
    return fetch(url, {
      method: "POST"
    }).then(function (res) {
      return res.json();
  ...
  function getTwitchStreams(_x) {
    return _getTwitchStreams.apply(this, arguments);
  }
  function _getTwitchStreams() {
    _getTwitchStreams = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(name) {
      var endpoint, authorizationObject, access_token, expires_in, token_type, authorization, headers;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              endpoint = "https://api.twitch.tv/helix/streams/?user_login=".concat(name);
              _context.next = 3;
            ...
            case 3:
              ...
              fetch(endpoint, {
                ...
                if (category === 'featured' && ((_data$data = data.data) === null || _data$data === void 0 ? void 0 : _data$data.length) === 0) {
                  var capOffline = document.querySelector('.-js-cap-offline');
                  var capLoading = document.querySelector('.-js-cap-loading');
                  capOffline.classList.remove('d-none');
                  capLoading.classList.add('d-none');
                }
                if (((_data$data2 = data.data) === null || _data$data2 === void 0 ? void 0 : _data$data2.length) > 0) {
                  if (data.data[0].type == 'live') {
                    var link = "https://player.twitch.tv/?channel=" + data.data[0].user_login + "&parent=elmorelab.com&autoplay=false&muted=false&theme=dark";
                    links.push(link);
                    renderStreams(link);
                  }
                }
  ...
  function renderStreams(data) {
    ...
    var streamHtml = "<div class=\"stream-card ".concat(hide, "\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<iframe\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tsrc=\"") + data + "\"\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tframeborder=\"0\" allowfullscreen=\"true\" autoplay='false'>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</iframe>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>";
    streamBlock.insertAdjacentHTML('beforeend', streamHtml);
  }
  function fetchStreamersJSON() {
    return _fetchStreamersJSON.apply(this, arguments);
  }
  function _fetchStreamersJSON() {
    _fetchStreamersJSON = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2() {
      var response, streamers;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return fetch(STREAMERS_PATH);
            case 2:
              response = _context2.sent;
              _context2.next = 5;
              return response.json();
            case 5:
              streamers = _context2.sent;
              return _context2.abrupt("return", streamers);
            case 7:
            case "end":
              return _context2.stop();
          }
  ...
  fetchStreamersJSON().then(function (json) {
    var streamers = json[category];
  ...
  var btn = document.querySelector('.-js-more-streams');
  if (btn) {
...
//require('~/app/js/vanillajs-validation.min.js');

//require('~/app/js/plugins/_scroll.js');
__webpack_require__(4);
__webpack_require__(19);
//require('~/app/js/plugins/_sliders.js');
//require('~/app/js/plugins/_clipboard.min.js')
//require('~/app/js/_dynamic_adapt.js')
