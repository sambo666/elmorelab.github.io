...
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(18), __webpack_require__(8)(module)))
  ...
  return function () {
    var e = {
        545: function _(e, t, r) {
          ...
          function v(e) {
            return Array.isArray(e) ? e.sort() : "object" === a(e) ? v(Object.keys(e)).sort(function (e, t) {
          ...
          function E(e, t) {
                ...
                switch (e.arrayFormat) {
                  ...
                  case "separator":
                    return function (t, r, n) {
                      ...
                      r = a ? h(r, e) : r;
                      var i = o || a ? r.split(e.arrayFormatSeparator).map(function (t) {
                        return h(t, e);
                      }) : null === r ? r : h(r, e);
                      n[t] = i;
                    };
                  case "bracket-separator":
                    return function (t, r, n) {
                      var o = /(\[\])$/.test(t);
                      if (t = t.replace(/\[\]$/, ""), o) {
                        var a = null === r ? [] : r.split(e.arrayFormatSeparator).map(function (t) {
                          return h(t, e);
                        });
            ...
            for (var g = 0, b = Object.keys(n); g < b.length; g++) {
              var E = b[g],
                S = n[E];
              if ("object" === a(S) && null !== S) for (var A = 0, C = Object.keys(S); A < C.length; A++) {
                var x = C[A];
                S[x] = _(S[x], t);
              } else n[E] = _(S, t);
            }
          ...
          t.extract = b, t.parse = E, t.stringify = function (e, t) {
            if (!e) return "";
            y((t = Object.assign({
              encode: !0,
              strict: !0,
            ...
            for (var r = function r(_r) {
                return t.skipNull && null == e[_r] || t.skipEmptyString && "" === e[_r];
              }, n = function (e) {
                switch (e.arrayFormat) {
                  case "index":
                    return function (t) {
                  ...
                  case "bracket-separator":
                    ...
                    return function (r) {
                      return function (n, o) {
                        return void 0 === o || e.skipNull && null === o || e.skipEmptyString && "" === o ? n : (o = null === o ? "" : o, 0 === n.length ? [[m(r, e), t, m(o, e)].join("")] : [[n, m(o, e)].join(e.arrayFormatSeparator)]);
                      };
                    };
                  default:
                    return function (t) {
              ...
              }(t), o = {}, a = 0, s = Object.keys(e); a < s.length; a++) {
              var l = s[a];
              r(l) || (o[l] = e[l]);
            }
            var u = Object.keys(o);
            return !1 !== t.sort && u.sort(t.sort), u.map(function (r) {
              var o = e[r];
            ...
            var o = Array.isArray(r) ? function (e) {
              return !r.includes(e);
            } : function (e, t) {
              return !r(e, t);
            };
        ...
        20: function _(e) {
          ...
          e.exports = function (e) {
            if ("string" != typeof e) throw new TypeError("Expected `encodedURI` to be of type `string`, got `" + _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e) + "`");
            try {
        ...
        729: function _(e) {
          ...
          Object.create && (n.prototype = Object.create(null), new n().__proto__ || (r = !1)), s.prototype.eventNames = function () {
              ...
              for (u = 0; u < d; u++) {
                switch (c[u].once && this.removeListener(e, c[u].fn, void 0, !0), p) {
                  ...
                  case 4:
                    ...
                    break;
                  default:
                    if (!l) for (f = 1, l = new Array(p - 1); f < p; f++) {
                      l[f - 1] = arguments[f];
                    }
            ...
            if (s.fn) s.fn !== t || o && !s.once || n && s.context !== n || i(this, a);else {
        ...
        698: function _(e) {
          function t(r) {
            return e.exports = t = "function" == typeof Symbol && "symbol" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(Symbol.iterator) ? function (e) {
    ...
    return function () {
      ...
      function t(t, r) {
        ...
        _e3(t, r), t.prototype = null === r ? Object.create(r) : (n.prototype = r.prototype, new n());
      }
      var _o = function o() {
      ...
      var _ = {
        ...
        E = function (e) {
          ...
          return t(r, e), r.prototype._setWindowRef = function (e) {
            this._embedWindow = e;
        ...
        S = function (e) {
          function r(t, r) {
            ...
            return n._options = {}, n._target = null, n._player = new E(), n._eventEmitter = null, n._iframe = null, n._forwardEmbedEvents = function (e) {
              if (n._iframe) {
                var t = e.data,
            ...
            }(r), n._options = r, n._target = function (e) {
              ...
              return t;
            }(t), n._eventEmitter = new u(), n.render(), n;
          }
          return t(r, e), r.prototype.addEventListener = function (e, t) {
      ...
      var A = {
        ...
        Player: function (e) {
          ...
          return t(r, e), r.prototype.buildIframe = function () {
...
window.onload = function () {
  ...
  var enableSwiper = function enableSwiper() {
    ...
    mySwiper = new core_class('.swiper', (_SwiperCore = {
      //observer: true,
      //observeParents: true,
      //speed: 500,
      //slidesPerView: 'auto',
    ...
    }, defineProperty_default()(_SwiperCore, "autoplay", false), defineProperty_default()(_SwiperCore, "slideToClickedSlide", true), _SwiperCore));
  ...
  var imagesBg = document.querySelector('.images');
  if (imagesBg) {
    var setImagesBgHeight = function setImagesBgHeight() {
      var scrollHeight = document.body.scrollHeight;
      imagesBg.style.height = scrollHeight + 'px';
    };
    setImagesBgHeight();
  }
  var imagesFull = document.querySelector('.images-full');
  if (imagesFull) {
    var setImagesFullHeight = function setImagesFullHeight() {
      var scrollHeight = document.body.scrollHeight;
      imagesFull.style.height = scrollHeight + 'px';
    };
    setImagesFullHeight();
  }

  //const tabsItems = document.querySelectorAll('')
  ...
  if (showLink) {
    ...
    // 	e.preventDefault();
    // 	const newComments = comments.splice(0,10);
    ...
    // 		}, 100);
    // 	});
    // 	if (comments.length === 0) showLink.remove();
    // });
  }
  ...
  var tooltips = document.querySelectorAll('.-js-tip');
  ...
  var resizeHall = function resizeHall(epicHall) {
    var dimensions = epicHall.getBoundingClientRect();
